...
Now you can manage your resources through your CLI. To deploy the resources on Azure, follow this:
...
2.1 If it says `NotRegistered`, register it

```bash
az provider register --namespace Microsoft.AlertsManagement
```

2.2 Wait a minute or 2 and verify the status is `Registered`
...
az deployment group create \
  --resource-group claims-processing-hack \
  --template-file challenge-0/infra/azuredeploy.json
```

Another way to deploy is to just click on this button!
